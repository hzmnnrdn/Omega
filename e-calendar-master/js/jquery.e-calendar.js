...
(function ($) {
    ...
    $.fn.eCalendar.defaults = {
        ...
        url: '',
        events: [
            {title: 'Testing1', description: 'i need more sleep', datetime: new Date(2018, new Date().getMonth(), 12, 17)},
            {title: 'Testing2', description: 'yohohoho', datetime: new Date(2018, new Date().getMonth(), 23, 16)},
            {title: 'Pening kepala', description: 'tatatataat', datetime: new Date(2018, new Date().getMonth(), 31, 16)}
